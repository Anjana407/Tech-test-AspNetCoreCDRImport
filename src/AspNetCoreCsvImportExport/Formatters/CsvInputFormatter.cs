...
namespace AspNetCoreCsvImport.Formatters
{
    ...
    /// </summary>
    /// 
   // The Custom csv input formatter implements the InputFormatter class.
   // This checks if the context ModelType property is a type of IList and if so,
   // converts the csv data to a List of Objects of type T using reflection.
